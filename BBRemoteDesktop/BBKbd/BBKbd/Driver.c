...
#define KEYBOARD_HID_REPORT_ID 1

#define MODE_TOUCHPAD 2
#define MODE_OPTICAL 3
#define MOUSE_HID_REPORT_SIZE 3
#define MOUSE_HID_REPORT_ID 2

#define MODE_GAMEPAD 6
...
UCHAR MouseReportDescriptor[] = {
	...
	0x91, 0x01,                    //   OUTPUT(Cnst,Var,Abs)*/ // I don't think we need these
...
VOID
VhfSourceDeviceCleanup( // TODO: are we calling this?
...
EvtTimerFunc(
	...
	UCHAR buffer[KEYBOARD_HID_REPORT_SIZE+1] = { 0 };
	...
	if (buffer[0])
	{
		...
		report.reportBufferLen = KEYBOARD_HID_REPORT_SIZE;
		report.reportId = KEYBOARD_HID_REPORT_ID;
