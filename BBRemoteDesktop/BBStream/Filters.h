...
// the actual object, which contains pins (in this case, only one; I should change it to 2 when I include audio)
...
public:
	...
	// IUnknown is part of every interface. It's used to switch between interfaces when there is multiple inheritance.
	...
	//  IQualityControl
	//////////////////////////////////////////////////////////////////////////
	STDMETHODIMP Notify(IBaseFilter * pSender, Quality q); // I can probably remove this
