 ...
 */
public class AxisBluetoothTransmitter extends BluetoothTransmitter {

    public AxisBluetoothTransmitter() throws IOException {
        super();
    }

    public void sendKeys(Map<Integer, Byte> axisMovements) throws IOException {
